...
<div class="container mainmenu"  ng-controller="bonusController" ng-init="GetBonus()">
<?php
...
<div class="col-sm-9 mainmenu">
 ...
 <div class="panel panel-default">
      <div class="panel-heading">
         <h3 style="width:100%; text-align:center; padding:2%; color:green; text-transform:capitalize">My-Bonuses R {{bonus}}</h3>
      </div>
