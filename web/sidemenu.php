...
<ul class="list-group ">
  ...
  <li class="list-group-item" ng-repeat="chat in chats" >
	...
	<div href=""  ng-if="chat.senderName != 'Admin'" class="sent">
		{{chat.message}}
	</div>
  </li>

  <li class="list-group-item">
 <textarea class="form-control" style="height: 40px; border-radius: 15px;" rows="5" ng-model="messageBody"></textarea>  </li>
   <li class="list-group-item">
<button type="button" class="btn btn-info" ng-click="Send()">Send</button>  </li>
</ul>
